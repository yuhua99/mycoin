...
from lib.private import key, secret
...
if __name__ == '__main__':
    ...
    try:
        ...
        result = client.get_public_all_tickers('ethtwd')
        print(f"[I] Invoked get_public_all_tickers('ethtwd') API Result: \n    {result}\n")
        ...
        # result = client.get_private_trade_history('ethtwd')
        # print(f"[I] Invoked get_private_trade_history('ethtwd') API Result: \n    {result}\n")
